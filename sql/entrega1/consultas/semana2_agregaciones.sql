...
-- Semana 2: consultas de agregacion y agrupamiento
-- ============================================================
...
-- Consulta 5: Estadio(s) con mas partidos por edicion
SELECT 
    p.id_edicion,
    e.nombre AS estadio,
...
-- Consulta 9: Partido con mayor marcador combinado por estadio
...
-- Consulta 12: Goles en fase de grupos vs. fase eliminatoria por seleccion
SELECT s.pais,
...
-- Consulta 13: Estadios que hayan albergado partidos en mas de una fase distinta
